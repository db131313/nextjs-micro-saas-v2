  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-6 relative">
      <div className="absolute top-4 right-4">
        <button onClick={() => setSettingsOpen(!settingsOpen)} className="text-white text-2xl">
          <FaCog />
        </button>
      </div>
      {settingsOpen && (
        <div className="absolute top-12 right-4 bg-white text-black p-4 rounded-lg shadow-md">
          <label className="block mb-2">Grid Columns:</label>
          <select onChange={(e) => setGridCols(e.target.value)} className="w-full p-2 mb-2 border rounded">
          ...
          <select onChange={(e) => setBorderRadius(e.target.value)} className="w-full p-2 mb-2 border rounded">
          ...
          <label className="block mb-2">Grid Gap:</label>
          <select onChange={(e) => setGap(e.target.value)} className="w-full p-2 mb-2 border rounded">
